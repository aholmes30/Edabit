...
public class SpotlightSum {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(spotlightSum(7));
    }
...
The spotlight sum can be defined as the total of the 8 numbers immediately surrounding
the number n on the grid, including n in the total.
